...
def format_homework(id, name, type):
    ...
    link = f"https://danteloopz.notion.site/{link_name}-{link_id}?pvs=4"
...
class GroupView(discord.ui.View):
    ...
    async def select_callback(self, interaction: discord.Interaction, select_item: discord.ui.Select):
        ...
        embed.description = "[*STRONA*](https://danteloopz.notion.site/)\n"

        if homework is None:
            embed.title = "Na jutro nie ma zadnych zadan"
        else:
